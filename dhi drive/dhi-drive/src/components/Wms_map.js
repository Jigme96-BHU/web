            ...
            <main class="bg-white h-screen overflow-hidden relative">
                <div class="flex items-start justify-between">
                    ...
                    <div class="flex flex-col w-full md:space-y-4">
                        ...
                        <iframe title="BHT Map"  width="100%" height="600" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=thimphu+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>                       </div>
                        {/************************ Dash content end ************************************/}
                    </div>            
                </div>
            </main>  
